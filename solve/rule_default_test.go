...
func TestRuleDefault(t *testing.T) {
	...
	testCases := []struct {
		...
		name:        `one lines and one avoid: right & down`,
		startLines:  right,
		startAvoids: down,
		expLines:    right,
		expAvoids:   down,
	}, {
		name:        `one lines and one avoid: right & left`,
		startLines:  right,
		startAvoids: left,
		expLines:    right,
		expAvoids:   left,
	}, {
		name:        `one lines and one avoid: right & up`,
		startLines:  right,
		startAvoids: up,
		expLines:    right,
		expAvoids:   up,
	}, {
		name:        `one lines and one avoid: down & left`,
		startLines:  down,
		startAvoids: left,
		expLines:    down,
		expAvoids:   left,
	}, {
		name:        `one lines and one avoid: down & up`,
		startLines:  down,
		startAvoids: up,
		expLines:    down,
		expAvoids:   up,
	}, {
		name:        `one lines and one avoid: left & up`,
		startLines:  left,
		startAvoids: up,
		expLines:    left,
		expAvoids:   up,
		...
		name:        `one avoid and two lines: left vs. right & down`,
		startAvoids: left,
		startLines:  right | down,
		expLines:    right | down,
		expAvoids:   left | up,
	}, {
		name:        `one avoid and two lines: up vs. right & down`,
		startAvoids: up,
		startLines:  right | down,
		expLines:    right | down,
		expAvoids:   left | up,
	}, {
		name:        `one avoid and two lines: down vs. right & left`,
		startAvoids: down,
		startLines:  right | left,
		expLines:    right | left,
		expAvoids:   up | down,
	}, {
		name:        `one avoid and two lines: up vs. right & left`,
		startAvoids: up,
		startLines:  right | left,
		expLines:    right | left,
		expAvoids:   up | down,
	}, {
		name:        `one avoid and two lines: left vs. right & up`,
		startAvoids: left,
		startLines:  right | up,
		expLines:    right | up,
		expAvoids:   left | down,
	}, {
		name:        `one avoid and two lines: down vs. right & up`,
		startAvoids: down,
		startLines:  right | up,
		expLines:    right | up,
		expAvoids:   left | down,
	}, {
		name:        `one avoid and two lines: right vs. down & left`,
		startAvoids: right,
		startLines:  down | left,
		expLines:    down | left,
		expAvoids:   up | right,
	}, {
		name:        `one avoid and two lines: up vs. down & left`,
		startAvoids: up,
		startLines:  down | left,
		expLines:    down | left,
		expAvoids:   up | right,
	}, {
		name:        `one avoid and two lines: left vs. down & up`,
		startAvoids: left,
		startLines:  down | up,
		expLines:    down | up,
		expAvoids:   left | right,
	}, {
		name:        `one avoid and two lines: right vs. down & up`,
		startAvoids: right,
		startLines:  down | up,
		expLines:    down | up,
		expAvoids:   left | right,
	}, {
		name:        `one avoid and two lines: right vs. left & up`,
		startAvoids: right,
		startLines:  left | up,
		expLines:    left | up,
		expAvoids:   down | right,
	}, {
		name:        `one avoid and two lines: down vs. left & up`,
		startAvoids: down,
		startLines:  left | up,
		expLines:    left | up,
		expAvoids:   down | right,
